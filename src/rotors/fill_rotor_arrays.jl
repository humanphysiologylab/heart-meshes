...
function fill_rotor_arrays!(ag::ActivatedGraph)
    ...
    summary_info = Dict{ag.type_array, Any}()
    ...
    while true
        ...
        summary_info_item = visit_breaks!(i_t_min, g = ag, dt_max = 20.)
        summary_info[i_t_min] = summary_info_item
